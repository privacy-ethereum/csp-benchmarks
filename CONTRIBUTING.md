...
You can reference the existing benchmarks for naming. (e.g. [./binius/benches/sha256_bench.rs](https://github.com/privacy-ethereum/csp-benchmarks/blob/collect-benchmarks-0/binius/benches/sha256_bench.rs))
...
You can reference how to create JSON files of metrics in the existing benchmarks.(e.g. [./binius/benches/sha256_bench.rs](https://github.com/privacy-ethereum/csp-benchmarks/blob/collect-benchmarks-0/binius/benches/sha256_bench.rs))
...
You can reference how to use the script in README file of existing benchmarks.(e.g. [./binius/README.md](https://github.com/privacy-ethereum/csp-benchmarks/blob/collect-benchmarks-0/binius/README.md#measure-sha256-ram-footprint))
