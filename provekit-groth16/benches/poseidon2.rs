use provekit_groth16_bench::{
    PROVEKIT_GROTH16_PROPS, num_constraints, prepare_poseidon2, preprocessing_size, proof_size,
    prove, verify,
};
...
utils::define_benchmark_harness!(
    ...
    |input_size| (input_size == 4).then_some(utils::bench::Acceleration::Precompile),
    prepare_poseidon2,
