...
uint get_total_signal_no() {return 658241;}

uint get_number_of_components() {return 15643;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 155959;}
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[128]{0};
}
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1024)]);
}
...
LinearizedKeccakF_60_create(mySignalStart+6656,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[4];
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[10])) + 1280)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 2367];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[10]))) + 2368)];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[1]);
}
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[2]); // line circom 44
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[11];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[11]))) + 2368)]);
}
{
PFrElement aux_dest = &lvar[13];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (0 + Fr_toInt(&lvar[11]))) + 1280)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[11]))) + 5568)];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[11]))) + 5568)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 3968];
// load src
cmp_index_ref_load = 0;
cmp_index_ref_load = 0;
// end load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1600 + (1 * Fr_toInt(&lvar[11]))) + 2368)]);
}
{
PFrElement aux_dest = &lvar[11];
// load src
...
KeccakSponge_61_create(mySignalStart+1280,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 256],1024);
}
// need to run sub component
...
UnpackBytes_1_create(mySignalStart+655744,15512+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 15512+ctx_index+1;
}
{
std::string new_cmp_name = "keccak";
Keccak_256_62_create(mySignalStart+160,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "pack";
PackBytes_63_create(mySignalStart+655456,15511+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 15511+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
...
cmp_index_ref_load = 0;
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],1024);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1024;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
{
std::string new_cmp_name = "keccak";
Keccak_256_bytes_64_create(mySignalStart+192,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 160)]); // line circom 26
}}
