...
uint get_total_signal_no() {return 5248449;}

uint get_number_of_components() {return 125102;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 1247441;}

uint get_size_of_constants() {return 90;}
...
// load src
Fr_mod(&expaux[0],&lvar[0],&circuitConstants[88]); // line circom 62
// end load src
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_mul(&expaux[1],&lvar[4],&circuitConstants[89]); // line circom 71
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_band(&expaux[0],&lvar[2],&circuitConstants[88]); // line circom 72
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[1024]{0};
}
...
uint csoffset = mySignalStart+9216;
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 8192)]);
}
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+40256;
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[82]); // line circom 30
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[10])) + 8448)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 17151];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[86]); // line circom 33
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[10])) + 8448)];
// load src
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[10]))) + 17152)];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[1]);
}
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[0]); // line circom 44
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[11];
// load src
...
Fr_lt(&expaux[0],&lvar[11],&circuitConstants[84]); // line circom 46
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[12];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1600 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 17152)]);
}
{
PFrElement aux_dest = &lvar[13];
// load src
Fr_mul(&expaux[1],&lvar[10],&circuitConstants[84]); // line circom 48
Fr_add(&expaux[0],&expaux[1],&lvar[11]); // line circom 48
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[0])) + 8448)]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + (((1088 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 31552)];
// load src
...
Fr_lt(&expaux[0],&lvar[11],&circuitConstants[84]); // line circom 53
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1088 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 31552)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1600 * (Fr_toInt(&lvar[10]) + 1)) + 17152)];
// load src
...
Fr_lt(&expaux[0],&lvar[11],&circuitConstants[83]); // line circom 60
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[11])) + 0)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((12800 + (1 * Fr_toInt(&lvar[11]))) + 17152)]);
}
{
PFrElement aux_dest = &lvar[11];
// load src
...
KeccakSponge_61_create(mySignalStart+8448,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 256],8192);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 8192;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
UnpackBytes_1_create(mySignalStart+5228928,124075+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 124075+ctx_index+1;
}
{
std::string new_cmp_name = "keccak";
Keccak_256_62_create(mySignalStart+1056,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "pack";
PackBytes_63_create(mySignalStart+5228640,124074+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 124074+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 8192];
// load src
// end load src
...
cmp_index_ref_load = 0;
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],8192);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 8192;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
{
std::string new_cmp_name = "keccak";
Keccak_256_bytes_64_create(mySignalStart+1088,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1056)]); // line circom 26
}}
