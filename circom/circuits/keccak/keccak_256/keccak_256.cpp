...
uint get_total_signal_no() {return 1313985;}

uint get_number_of_components() {return 31280;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 311885;}
...
uint csoffset = mySignalStart+2304;
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 2048)]);
}
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+11456;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[10])) + 2304)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 4479];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[10]))) + 4480)];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[1]);
}
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[10]); // line circom 44
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[11];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1600 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 4480)]);
}
{
PFrElement aux_dest = &lvar[13];
// load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + (((1088 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 9280)];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1088 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 9280)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1600 * (Fr_toInt(&lvar[10]) + 1)) + 4480)];
// load src
...
Fr_lt(&expaux[0],&lvar[11],&circuitConstants[3]); // line circom 60
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[11])) + 0)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((3200 + (1 * Fr_toInt(&lvar[11]))) + 4480)]);
}
{
PFrElement aux_dest = &lvar[11];
// load src
...
KeccakSponge_61_create(mySignalStart+2304,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 256],2048);
}
// need to run sub component
...
UnpackBytes_1_create(mySignalStart+1309056,31021+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 31021+ctx_index+1;
}
{
std::string new_cmp_name = "keccak";
Keccak_256_62_create(mySignalStart+288,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "pack";
PackBytes_63_create(mySignalStart+1308768,31020+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 31020+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2048];
// load src
// end load src
...
cmp_index_ref_load = 0;
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],2048);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 2048;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
{
std::string new_cmp_name = "keccak";
Keccak_256_bytes_64_create(mySignalStart+320,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 288)]); // line circom 26
}}
