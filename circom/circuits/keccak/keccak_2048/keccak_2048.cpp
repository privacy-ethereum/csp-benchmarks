...
uint get_total_signal_no() {return 10494401;}

uint get_number_of_components() {return 250198;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 2494849;}
...
uint csoffset = mySignalStart+18432;
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 16384)]);
}
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+78656;
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[10])) + 16640)];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 34047];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[10]))) + 34048)];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[1]);
}
...
Fr_lt(&expaux[0],&lvar[10],&circuitConstants[20]); // line circom 44
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[11];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1600 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 34048)]);
}
{
PFrElement aux_dest = &lvar[13];
// load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + (((1088 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 61248)];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1088 * Fr_toInt(&lvar[10])) + (1 * Fr_toInt(&lvar[11]))) + 61248)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1600 * (Fr_toInt(&lvar[10]) + 1)) + 34048)];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((25600 + (1 * Fr_toInt(&lvar[11]))) + 34048)]);
}
{
PFrElement aux_dest = &lvar[11];
// load src
...
KeccakSponge_61_create(mySignalStart+16640,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
// load src
// end load src
Fr_copyn(aux_dest,&signalValues[mySignalStart + 256],16384);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 16384;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
UnpackBytes_1_create(mySignalStart+10455424,248147+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 248147+ctx_index+1;
}
{
std::string new_cmp_name = "keccak";
Keccak_256_62_create(mySignalStart+2080,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "pack";
PackBytes_63_create(mySignalStart+10455136,248146+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 248146+ctx_index+1;
}
{
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 16384];
// load src
// end load src
...
cmp_index_ref_load = 0;
// end load src
Fr_copyn(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],16384);
}
// need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 16384;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
...
{
std::string new_cmp_name = "keccak";
Keccak_256_bytes_64_create(mySignalStart+2112,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
{
{{
Fr_eq(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 0)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 2080)]); // line circom 26
}}
